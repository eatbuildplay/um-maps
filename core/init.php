...
class PP_Maps_API {
	...
	function plugin_check() {
		...
		} else if ( ! version_compare( ultimatemember_version, PP_MAPS_REQUIRES, '>=' ) ) {
	...
	function init() {
		...
		require_once PP_MAPS_PLUGIN_DIR . 'core/register-scripts.php';
		require_once PP_MAPS_PLUGIN_DIR . 'core/utils.php';
		require_once PP_MAPS_PLUGIN_DIR . 'core/metabox.php';
		require_once PP_MAPS_PLUGIN_DIR . 'core/display.php';
		require_once PP_MAPS_PLUGIN_DIR . 'core/geocode.php';
		require_once PP_MAPS_PLUGIN_DIR . 'core/shortcode.php';
		require_once PP_MAPS_PLUGIN_DIR . 'admin/settings.php';
		require_once PP_MAPS_PLUGIN_DIR . 'admin/user-column.php';
		require_once PP_MAPS_PLUGIN_DIR . 'admin/role-metabox.php';
